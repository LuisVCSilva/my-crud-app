...
class Credits:
   ...
   def run():
      return json.dumps({"text":["An app made by LuisVCSilva","<p>Malba is a easy to use mathematical engine</p><p>Made by Luis Vinicius Costa Silva</p><p>Meet me at Twitter/GitHub: @LuisVCSilva</p>"]})
